...
class SpotifyData(Spotify):
    def __init__(self, spotify_playlist):
        ...
        # Create dictionary containing track names as keys and Spotify 01_data as items
                    ...
                    artists_and_title:
                        {
                            ...
                            "release_date": self.playlist_music[n]['track']['album']['release_date'],
                            "release_date_precision": self.playlist_music[n]['track']['album']['release_date_precision'],
                        }
                }
            )
